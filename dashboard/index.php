                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                          echo "<tr><td>" . $row["service_name"] . "</td><td>" . $row["service_game"] . "</td><td>" . $row["service_type"] . "</td><td>" . $row["service_description"] . "</td><td>" . $row["service_start_hour"] . "</td><td>" . $row["service_end_hour"] . "</td><td><a href='service_edit.php?service_id=" . $row["service_id"] . "'>Edit</a></td></tr>";
                        }
                      } else {
                        echo "<tr><td colspan='5'>No order yet.</td></tr>";
                      }
