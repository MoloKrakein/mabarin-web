<?php
// check if user is logged in, if not $logged_in = false
session_start();
$logged_in = false;
        ...
        <nav class="navbar bg-body-dark border-bottom sticky-top">
            <div class="container-fluid">
                ...
                <form class="d-flex" role="search">
                    <?php if ($logged_in) : ?>
                        <a href="profile.php" class="btn btn-light me-2" type="button">Profile</a>
                        <a href="logout.php" class="btn btn-warning" type="button">Logout</a>
                        <?php else : ?>
